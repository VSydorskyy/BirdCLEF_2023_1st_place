...
CONFIG = {
    ...
    "split_path": None,
    "exp_name": f"convnext_small_fb_in22k_ft_in1k_384_Exp_noamp_64bs_5sec_mixupP05_RandomFiltering_balancedSampler_lr1e4_CosineLREpoch50_ValV2_202xXcAddDataNoAddSecLabelsMayXCV1_BackGroundSoundScapeP05_SpecAugV1_FocalLoss_TuneV3_noval",
    "files_to_save": (
    ...
    "train_function_args": {
        ...
        "use_sampler": True,
        "pretrained_chekpoints": "logdirs/convnext_small_fb_in22k_ft_in1k_384_Exp_noamp_64bs_5sec_mixupP05_RandomFiltering_balancedSampler_lr1e4_CosineLREpoch50_202xXcAddDataNoAddSecLabelsMayXCV1_BackGroundSoundScapeORESC50P05_SpecAugV1_FocalLoss_noval_PretrainV3/checkpoints/model.last.pth",
